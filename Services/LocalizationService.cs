...
namespace Eraware.Modules.SummitApiDemo.Services
{
    ...
    using static Eraware.Modules.SummitApiDemo.ViewModels.LocalizationViewModel;
    ...
    public class LocalizationService : ILocalizationService
    {
            ...
            get
            {
                if (string.IsNullOrWhiteSpace(this.resourceFileRoot))
                {
                    this.resourceFileRoot = HostingEnvironment.MapPath(
                        "~/DesktopModules/SummitApiDemo/resources/App_LocalResources/");
                }
        ...
        public LocalizationService()
        {
            ...
            this.cacheKey = "Eraware.Modules.SummitApiDemo" + "_Localization_" + Thread.CurrentThread.CurrentCulture;

...
internal class Build : NukeBuild
{
    ...
    private const string prodViewsPath = "/DesktopModules/SummitApiDemo/resources/scripts/era-summitapidemo/";
    ...
    Target DeployFrontEnd => _ => _
        ...
        .Executes(() =>
        {
            var scriptsDestination = RootDirectory / "resources" / "scripts" / "era-summitapidemo";
            EnsureCleanDirectory(scriptsDestination);
            CopyDirectoryRecursively(RootDirectory / "module.web" / "dist" / "era-summitapidemo", scriptsDestination, DirectoryExistsPolicy.Merge);
        });
    ...
    Target Swagger => _ => _
        ...
        .Executes(() =>
        {
            ...
            NSwagTasks.NSwagWebApiToOpenApi(c => c
                .AddAssembly(RootDirectory / "bin" / Configuration / "Eraware.Modules.SummitApiDemo.dll")
                .SetInfoTitle("Eraware DNN Summit API Demo")
